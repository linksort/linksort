module github.com/linksort/linksort
...
require (
	...
	github.com/dyatlov/go-readability v0.0.0-20150926130635-e7b2080f87f8
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/bedrockruntime v1.24.6 // indirect
