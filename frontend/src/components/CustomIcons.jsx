...
export const DotDotDotHoriz = createIcon({
  displayName: "DotDotDotHoriz",
  viewBox: "0 0 24 24",
  d:
    "M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z",
});

export const DotDotDotVert = createIcon({
  displayName: "DotDotDotVert",
  viewBox: "0 0 24 24",
  d:
    "M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z",
});

export const CondensedListIcon = createIcon({
  displayName: "CondensedListIcon",
  viewBox: "0 0 24 24",
...
export const TilesIcon = createIcon({
