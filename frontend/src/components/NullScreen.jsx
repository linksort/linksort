...
function Star() {
  return <Image src="/star.svg" height="80px" width="80px" />;
}

function CrystalBall() {
  return <Image src="/crystal-ball.svg" height="80px" width="80px" />;
}

function Beach() {
  return <Image src="/beach.svg" height="80px" width="80px" />;
}

function ThinkingFace() {
  return <Image src="/thinking-face.svg" height="80px" width="80px" />;
}
